...
type BsTrainingStudent struct {
	...
	Editer          string     `gorm:"column:editer;type:varchar(20);not null;default:''" json:"editer"`      // 编辑者
	ExtraField1     string     `gorm:"column:extra_field1;type:varchar(255)" json:"extra_field1"`             // 扩展字段1
